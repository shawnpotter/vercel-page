	...
	return (
		<div className='w-full h-screen text-center relative'>
			<div className='flex h-full w-full z-0'>
				<div className='absolute w-full h-[50rem] bg-black/[0.4] z-10'></div>
				<div className='flex w-full h-[50rem] bg-planets bg-center bg-auto z-0'></div>
			</div>
			<div className='flex h-full w-full p-2 -top-12 justify-center items-center z-20 absolute'>
				<div>
					<Image
